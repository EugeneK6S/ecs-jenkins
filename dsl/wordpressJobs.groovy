listView('Wordpress') {
	...
	String[] jobNames = [ "wordpress-deploy", "wordpress-delete", "wordpress-clone-databases", "wordpress-restore-from-bucket" ];
		...
		definition {
			cpsScm {
				scm {
					git {
						remote {
							url('https://git-codecommit.us-west-1.amazonaws.com/v1/repos/wordpress_devops')
							credentials('')
							branch('master')
						}
					}
